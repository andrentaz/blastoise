...
ifeq ($(shell uname), Darwin)
	...
	#CC_ARGS    = -m64 -O2 -Wall -std=c++11 -D_GLIBCXX_USE_CXX11_ABI=0 -pthread -fopenmp
	CC_ARGS    = -m64 -std=c++11 -D_GLIBCXX_USE_CXX11_ABI=0 -g -pthread -fopenmp
	...
	PLATFORM = linux64
	CC      = g++
	#CC_ARGS    = -m64 -O2 -Wall -std=c++11 -pthread -fopenmp 
	CC_ARGS    = -m64 -std=c++11 -D_GLIBCXX_USE_CXX11_ABI=0 -g -pthread -fopenmp 
	RELEASE := $(shell uname -r | cut -f 1 -d .)
	CC_LIB   = -lm -lpthread
